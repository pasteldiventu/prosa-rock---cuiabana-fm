    ...
    <main>
      <section className="relative flex min-h-screen items-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="mb-6 text-6xl font-bold leading-none md:text-8xl">
            A SUA DOSE <br />
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <a
              href="#episodios"
              className="rounded-sm border border-zinc-800 bg-zinc-900 px-8 py-4 text-center font-display uppercase tracking-wider text-white hover:bg-zinc-800"
            >
              Ultimos Episodios
            </a>
          </div>
        </div>
        <div className="pointer-events-none absolute bottom-0 right-0 h-1/2 w-1/3 rounded-full bg-neon-orange/5 blur-[120px]" />
      </section>

      <section id="sobre" className="relative bg-dark-bg py-24">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-4 sm:px-6 md:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mb-8 text-lg leading-relaxed text-zinc-400">
              Todos os sabados, Cimone Lima recebe convidados especiais para um bate-papo sem roteiro, onde a musica
              dita o ritmo da prosa.
            </p>
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                <div className="rounded-lg bg-zinc-900 p-2 text-neon-orange">
          ...
          <div className="relative">
            <img
              ...
              className="relative z-10 aspect-square rounded-full border-4 border-zinc-900 object-cover"
              referrerPolicy="no-referrer"
            />
            <div className="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-neon-orange/20 blur-xl" />
            <div className="absolute -bottom-8 -left-8 h-32 w-32 rounded-full bg-neon-yellow/10 blur-xl" />
          </div>
        </div>
      </section>

      <section id="episodios" className="border-y border-zinc-800 bg-dark-surface py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div>
              <h2 className="mb-3 text-4xl font-bold">
                ULTIMOS <span className="text-neon-orange">EPISODIOS</span>
              </h2>
            ...
            <Link href="/blog" className="whitespace-nowrap rounded-sm border border-zinc-700 bg-zinc-900 px-6 py-3 font-display uppercase tracking-wider text-white hover:bg-zinc-800">
              Ver Blog
            </Link>
          </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            <h2 className="mb-6 text-4xl md:text-5xl">
              APOIE A <span className="text-neon-yellow">CENA LOCAL</span>
            </h2>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-8">
            {[
              ...
              <div key={band.name} className="group relative aspect-square overflow-hidden rounded-lg border border-zinc-800">
                <img src={band.img} alt={band.name} className="h-full w-full object-cover grayscale transition-all duration-500 group-hover:scale-110 group-hover:grayscale-0" referrerPolicy="no-referrer" />
      ...
      <section className="relative overflow-hidden border-t border-zinc-800 bg-dark-surface py-24">
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 backdrop-blur-sm md:p-12">
            <div className="flex flex-col items-center gap-12 md:flex-row">
              <div className="h-48 w-48 shrink-0 overflow-hidden rounded-full border-4 border-neon-orange/30 md:h-64 md:w-64">
                <img
                  src="cimone-lima.jpg"
                  alt="Cimone Lima"
              ...
              <div>
                <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-neon-orange/20 bg-neon-orange/10 px-3 py-1 text-neon-orange">
                ...
                <p className="mb-6 text-lg leading-relaxed text-zinc-400">
                  Com mais de 15 anos de experiencia no radio mato-grossense, Cimone respira musica. Sua paixao pelo rock e pela cultura alternativa levou a criacao do Prosa Rock.
                </p>
                <div className="flex gap-4">
                  ...
                  <span className="flex items-center gap-2 text-sm uppercase tracking-wider text-zinc-500">
                    <Mic2 className="h-4 w-4 text-neon-orange" />
                    10 Anos no Ar
                  </span>
                </div>
              </div>
